...
class MainDashboard:
    ...
    def create_widgets(self):
        # banner
        banner_label = tk.Label(root, text="Finance Dashboard Sign-On", bg="blue", fg="white", font=("Arial", 16))
        ...
        login_button = tk.Button(self.root, text="Login", command=self.login, width=20, height=2)
